...
| prod                        | -------------------------------------------------------------------prod---------------------------------------------------------------------------------------              | prod                                                                                               |
| prod-setup                  | npm run prod-volume && npm run prod-build && npm run prod-up && Node ./terminalString/mprod.js                                                                              | create docker volume, build and orchestrate containers                                             |
...
| test                        | ------------------------------------------------------------------test----------------------------------------------------------------------------------------              | test                                                                                               |
| test-setup                  | npm run test-volume && npm run test-build && npm run test-up && Node ./terminalString/mtest.js && npm run wait-Prisma && env-cmd ./.config/test.env npm run                 | create docker volume, build, orchestrate containers and open Node endpoint in browser(if possible) |
