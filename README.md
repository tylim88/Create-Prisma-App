...
Please study ./config/dev.env for better understanding on how environment variable works
    ...
    "separator-3": "---------------------------------------------------test---------------------------------------------------------------------------",
    "test-setup": "npm run test-build && npm run test-up && node ./terminalString/mtest.js && npm run wait-prisma && env-cmd ./.config/test.env npm run playground", build, orchestrate containers and open nodejs endpoint in browser
    ...
    "dev-browse": "cross-env-shell \"sleep 3\" && node ./terminalString/mdev.js && cross-env-shell \"sleep 5\" && env-cmd ./.config/dev.env npm run playground", open nodejs endpoint in browser
